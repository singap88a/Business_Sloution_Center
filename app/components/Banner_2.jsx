...
const cards = [
  {
    ...
    description:
      "نهتم بالمحتوي التدريبي القائم علي الواقع المهني أكثر من النظري مما يساعد المتدرب علي اكتساب العديد من المهارات والخبرات",
  },
  {
    image: Certificates_2,
    title: "شهادات معتمدة",
    description:
      "جميع الدورات بشهادات معتمدة وعدد ساعات معتمدة من المؤسسة العامة للتدريب التقني والمهني",
  },
];
