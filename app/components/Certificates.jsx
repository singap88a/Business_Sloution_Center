  ...
  const cards = [
    {
        ...
        titleKey: 'certificates.card1.title',
        descriptionKey: 'certificates.card1.description'
    },
    {
        image: Certificates_2,
        titleKey: 'certificates.card2.title',
        descriptionKey: 'certificates.card2.description'
    },
    {
        image: Certificates_3,
        titleKey: 'certificates.card3.title',
        descriptionKey: 'certificates.card3.description'
    }
  ];
            ...
            <SwiperSlide key={index}>
              ...
              >
                <div className="h-24 w-24 flex justify-center items-center rounded-full bg-[#dbfffc7a] mx-auto">
                  <Image src={card.image} alt={t(card.titleKey)} className="mx-auto" />
                </div>
