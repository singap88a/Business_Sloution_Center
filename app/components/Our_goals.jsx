    ...
    <div className="bg-[#f5fcff]" id="OurGoals">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between">
        ...
        <motion.div
          ...
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, margin: "0px 0px -100px 0px" }} // تم تصحيح viewport هنا
          variants={fadeInLeft}
        >
          ...
          <ul className="space-y-3">
            {[
              "تقديم تجربة تدريبية متميزة",
              "تنمية المهارات المهنية للمتدربين",
              "تحقيق أقصى درجات الاستفادة العلمية والمهنية لعملائنا",
              "تحقيق أعلى معايير الجودة في جميع الخدمات التدريبية",
              "توفير البرامج التدريبية التي تناسب جميع التخصصات الإدارية",
            ].map((goal, index) => (
